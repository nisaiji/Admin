...
describe('Admin Profile Form Tests', () => {
  ...
  test('renders school board select and validates on selection', async () => {
    ...
    fireEvent.change(schoolBoardSelect, { target: { value: requestBody.schoolBoard } });
  ...
  test('renders country, state, and district fields if country India', () => {
    ...
    // Select district
    fireEvent.change(districtSelect, { target: { value: requestBody.district } });
  ...
  test('save button is clickable for admin profile when form is valid', async () => {
    ...
    fireEvent.change(affiliation, { target: { value: requestBody.affiliation } });
    fireEvent.change(schoolNumber, { target: { value: requestBody.schoolNumber } });
    fireEvent.change(schoolAddress, { target: { value: requestBody.schoolAddress } });
    fireEvent.change(schoolBoardSelect, { target: { value: requestBody.schoolBoard } });
    ...
    await fireEvent.change(stateSelect, { target: { value: requestBody.state } });
    fireEvent.change(districtSelect, { target: { value: requestBody.district } });
